...
const Card: React.FC<CardProps> = ({ className, ...props }) => (
  <div
    className={`rounded-lg border bg-card text-card-foreground shadow-sm dark:bg-dark-card dark:text-dark-card-foreground dark:border-dark-border ${className}`}
    {...props}
  />
);
...
const CardDescription: React.FC<CardDescriptionProps> = ({ className, ...props }) => (
  <p className={`text-sm text-muted-foreground dark:text-dark-muted-foreground ${className}`} {...props} />
);
